def calculate_pallet_volume(pallet):
    ...
    block_volume = pallet.block_length * pallet.block_width * pallet.block_height * 9
    
    # Total volume in cubic millimeters
    total_volume = top_volume + bottom_volume + chassis_volume + block_volume
    
    # Convert to cubic meters and round to 6 decimal places
    return round(total_volume / 1_000_000_000, 6)  # Convert from mm³ to m³
